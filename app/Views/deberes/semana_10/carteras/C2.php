            ...
            <div class="row d-flex flex-wrap">
                ...
                <div class="col-auto">
                    <div class="card shadow">
                        <img src="<?= base_url('public/img/cartera de mano.webp') ?>" class="card-img-top" alt="cartera de mano">
                        <div class="card-body">
                            <h5 class="card-title">Cartera de Mano</h5>
                            <p class="card-text">Precio: 29.90 $</p>
