            ...
            <div class="row d-flex flex-wrap">
                ...
                <div class="col-auto">
                    <div class="card shadow">
                        <img src="<?= base_url('public/img/cartera de hombro.webp') ?>" class="card-img-top" alt="cartera de hombro">
                        <div class="card-body">
                            <h5 class="card-title">Cartera de Hombro</h5>
                            <p class="card-text">Precio: 35.99 $</p>
