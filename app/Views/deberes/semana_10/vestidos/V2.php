            ...
            <div class="row d-flex flex-wrap">
                ...
                <div class="col-auto">
                    <div class="card shadow">
                        <img src="<?= base_url('public/img/vestido formal.webp') ?>" class="card-img-top" alt="vestido formal">
                        <div class="card-body">
                            <h5 class="card-title">Vestido Formal</h5>
                            <p class="card-text">Precio: 55.50 $</p>
