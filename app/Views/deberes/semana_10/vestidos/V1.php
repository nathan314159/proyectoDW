            ...
            <div class="row d-flex flex-wrap">
                ...
                <div class="col-auto">
                    <div class="card shadow">
                        <img src="<?= base_url('public/img/vestido de fiesta.webp') ?>" class="card-img-top" alt="vestido de fiesta">
                        <div class="card-body">
                            <h5 class="card-title">vestido de fiesta</h5>
                            <p class="card-text">Precio: 62.00 $</p>
